...
alldata[a,] = c("n", ",", "data/numerator/morttotaldepreg.csv", "Total", "Mortality - Total", NA, -1, "New Zealand", "Regional Council"); a = a + 1
alldata[a,] = c("n", ",", "data/numerator/mortmaoridepreg.csv", "Maori", "Mortality - Total", NA, -1, "New Zealand", "Regional Council"); a = a + 1
alldata[a,] = c("n", ",", "data/numerator/mortnonmaoridepreg.csv", "Non-Maori", "Mortality - Total", NA, -1, "New Zealand", "Regional Council"); a = a + 1

alldata[a,] = c("n", ",", "data/numerator/morttotaldeptla.csv", "Total", "Mortality - Total", NA, -1, "New Zealand", "TLA"); a = a + 1
alldata[a,] = c("n", ",", "data/numerator/mortmaorideptla.csv", "Maori", "Mortality - Total", NA, -1, "New Zealand", "TLA"); a = a + 1
alldata[a,] = c("n", ",", "data/numerator/mortnonmaorideptla.csv", "Non-Maori", "Mortality - Total", NA, -1, "New Zealand", "TLA"); a = a + 1

alldata[a,] = c("n", ",", "data/numerator/morttotaldepdhb.csv", "Total", "Mortality - Total", NA, -1, "New Zealand", "DHB"); a = a + 1
alldata[a,] = c("n", ",", "data/numerator/mortmaoridepdhb.csv", "Maori", "Mortality - Total", NA, -1, "New Zealand", "DHB"); a = a + 1
alldata[a,] = c("n", ",", "data/numerator/mortnonmaoridepdhb.csv", "Non-Maori", "Mortality - Total", NA, -1, "New Zealand", "DHB"); a = a + 1
